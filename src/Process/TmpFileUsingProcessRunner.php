...
namespace Mishmash\GrumPHPParallelPhpCs\Process;
...
class TmpFileUsingProcessRunner
{
  ...
  {
    if (!$tmp = tmpfile()) {
      throw new \RuntimeException('The process requires a temporary file in order to run. We could not create one.');
    }
